...
struct Edge {
	...
	struct Z z1, z2;
    float Omega[ 3 * 3 ], omega_upperleft[ 3 * 3 ], omega_upperright[ 3 * 3 ], omega_bottomleft[ 3 * 3 ], omega_bottomright[ 3 * 3 ], xi_upper[ 3 * 1 ], xi_bottom[ 3 * 1 ];

    float lambda, hat_e[ 2 * 1 ];	// Needed when calculating cost
};
#ifdef __cplusplus
}
#endif
