...
struct Edge *obs_edge_self;

struct Edge* ObsEdge_create( struct Z z1, struct Z z2, struct HAT_X *hat_xs, float *snr ) {
    obs_edge_self = malloc ( sizeof( struct Edge ) );
    ...
    float s1 = sinf( obs_edge_self->hat_x1.hat_x[2] + obs_edge_self->z1.z[1] );
    float c1 = cosf( obs_edge_self->hat_x1.hat_x[2] + obs_edge_self->z1.z[1] );
    float s2 = sinf( obs_edge_self->hat_x2.hat_x[2] + obs_edge_self->z2.z[1] );
    float c2 = cosf( obs_edge_self->hat_x2.hat_x[2] + obs_edge_self->z2.z[1] );
    ...
    float Q1[ 2 * 2 ] = {
        powf( obs_edge_self->z1.z[0] * snr[0], 2.0f ), 0.0f,
        0.0f, powf( snr[1], 2.0f )
    };
    ...
    float Q2[ 2 * 2 ] = {
        powf( obs_edge_self->z2.z[0] * snr[0], 2.0 ), 0.0f,
        0.0f, powf( snr[1], 2.0f )
    };
    ...
    float B1[ 2 * 3 ] = {
        -1.0f, -0.0f, obs_edge_self->z1.z[0] * s1,
        -0.0f, -1.0f, -obs_edge_self->z1.z[0] * c1
    };
    ...
    float B2[ 2 * 3 ] = {
        1.0f, 0.0f, -obs_edge_self->z2.z[0] * s2,
        0.0f, 1.0f, obs_edge_self->z2.z[0] * c2
    };
    ...
    float transposeOFB1[ 3 * 2 ] = { 0.0f };
    tra( transposeOFB1, B1, 2, 3 );

    float transposeOFB2[ 3 * 2 ] = { 0.0f };
    tra( transposeOFB2, B2, 2, 3 );

    float dot_productOFtB1Omega[ 3 * 2 ] = { 0.0f };
    dot( dot_productOFtB1Omega, transposeOFB1, 3, 2, Omega, 2, 2 );

    float dot_productOFtB2Omega[ 3 * 2 ] = { 0.0f };
    dot( dot_productOFtB2Omega, transposeOFB2, 3, 2, Omega, 2, 2 );

    float dot_productOFtB1OmegaB1[ 3 * 3 ] = { 0.0f };
    ...
    float dot_productOFtB1OmegaB2[ 3 * 3 ] = { 0.0f };
    ...
    float dot_productOFtB2OmegaB1[ 3 * 3 ] = { 0.0f };
    ...
    float dot_productOFtB2OmegaB2[ 3 * 3 ] = { 0.0f };
    ...
    float dot_productOFtB1Omegahat_e[ 3 * 1 ] = { 0.0f };
    ...
    float dot_productOFtB2Omegahat_e[ 3 * 1 ] = { 0.0f };
    ...
    obs_edge_self->Omega[4] = 0.0f; // Not needed by ObsEdge
    obs_edge_self->Omega[5] = 0.0f; // Not needed by ObsEdge
    obs_edge_self->Omega[6] = 0.0f; // Not needed by ObsEdge
    obs_edge_self->Omega[7] = 0.0f; // Not needed by ObsEdge
    obs_edge_self->Omega[8] = 0.0f; // Not needed by ObsEdge

    obs_edge_self->lambda = 1.0f; // Not needed by ObsEdge
